        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExitedDate = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeJobCategory", x => new { x.EmployeeId, x.JobCategoryId });
                    table.ForeignKey(
                        name: "FK_EmployeeJobCategory_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeJobCategory_JobCategories_JobCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeJobCategory_JobCategoryId",
